<?php
	...
	include("function/mobilemoney.php");
?>
<!DOCTYPE html>
<html>
<head>
	<title>Gilbert Shoe Store</title>
...
<body>
	<div id="header">
		...
		<label>Gilbert Shoe Store</label>
...
<div id="container">
	<div class="nav">
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of Gilbert Shoe Store Inc.
					</center>
				</div>
			<div class="modal-footer">
				<center>
					<input type="image" src="images/button.jpg" border="0" name="mobilemoney" alt="Make payments with MobileMoney - it's fast, free and secure!"  />
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">Gilbert Shoe Store Inc. Terms and Condition</h3>
			</div>
				<div class="modal-body">
					<ul>
						...
						<li>All prices quoted are in Rwandan francs. Price and availability information is subject to change without notice.</li>
						<li>Mode of payment are as follows:customers with MobileMoney account can pay through MobileMoney otherwise Cash on Delivery(COD).</li>
						<li>Upon receiving your product we will charge for delivering for only 2,500 rwf, depending on the location.</li>
					</ul>
				</div>
			<div class="modal-footer">
				<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Close</button>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Gilbert Shoe Store Inc. Brought To You by <a href="https://faith7gilbert.com/">Faith Gilbert</a></p>
		</div>

			<div id="foot">
				<h4>Links</h4>
					<ul>
						<a href="http://www.facebook.com/GilbertShoeStore"><li>Facebook</li></a>
						<a href="http://www.twitter.com/GilbertShoeStore"><li>Twitter</li></a>
						<a href="http://www.pinterest.com/GilbertShoeStore"><li>Pinterest</li></a>
						<a href="http://www.pinterest.com/GilbertShoeStore"><li>Instagram</li></a>
						<a href="http://www.pinterest.com/GilbertShoeStore"><li>Linkedln</li></a>
					</ul>	
			</div>
	</div>
</body>
